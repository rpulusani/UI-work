        ...
        var Addresses = {
            ...
            columnDefs: {
                defaultSet: [
                    ...
                    {'name': $translate.instant('ADDRESS_MAN.COMMON.TXT_ADDRESS_1'), 'field':'addressLine1', width: 200},
                    {'name': $translate.instant('ADDRESS_MAN.COMMON.TXT_ADDRESS_2'), 'field':'addressLine2', width: 200},
                    {'name': $translate.instant('ADDRESS.REGION'), 'field':'region'},
                    {'name': $translate.instant('ADDRESS_MAN.COMMON.TXT_CITY'), 'field': 'city', width: 200},
                    ...
                    {'name': $translate.instant('ADDRESS.COUNTY'), 'field': 'county', width: 210},
