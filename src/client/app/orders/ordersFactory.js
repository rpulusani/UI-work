        ...
        var OrderRequest = {
                ...
                columnDefs: {
                    defaultSet: [
                        ...
                        {'name': $translate.instant('SERVICE_REQUEST.COST_CENTER'), 'field':'costCenter', visible: false , 'notSearchable': true},
                        {'name': $translate.instant('ORDER_MGT.TRACKING_NUMBER'), 'field':'', visible: false, 'notSearchable': true},
                        {'name': $translate.instant('SERVICE_REQUEST.HELPDESK_REFERENCE'), 'field':'customerReferenceId',visible: false, 'notSearchable': true},
                        {'name': $translate.instant('ORDER_MGT.PO'), 'field':'purchaseOrderNumber', visible: false, 'notSearchable': true},
                        {'name': $translate.instant('SERVICE_REQUEST.PRIMARY_CONTACT'), 'field': 'getFullRequestorName()',visible: false, 'notSearchable': true},
                    ...
                    suppliesSet: [
                        ...
                        {'name': $translate.instant('ADDRESS.NAME'), 'field':'status', visible: false, 'notSearchable': true},
                        {'name': $translate.instant('ORDER_MGT.TRACKING_NUMBER'), 'field':'', visible: false, 'notSearchable': true},
                        {'name': $translate.instant('ADDRESS.STORE_NAME'), 'field':'', visible: false, 'notSearchable': true},
                        {'name': $translate.instant('SERVICE_REQUEST.HELPDESK_REFERENCE'), 'field':'customerReferenceId', visible: false, 'notSearchable': true},
                        {'name': $translate.instant('SERVICE_REQUEST.COST_CENTER'), 'field':'costCenter', visible: false, 'notSearchable': true},
                        {'name': $translate.instant('ORDER_MGT.PO'), 'field':'purchaseOrderNumber', visible: false, 'notSearchable': true},
                        {'name': $translate.instant('SERVICE_REQUEST.PRIMARY_CONTACT'), 'field': 'getFullRequestorName()',visible: false, 'notSearchable': true},
                        {'name': $translate.instant('SERVICE_REQUEST.REQUESTOR_CONTACT'), 'field': 'getFullPrimaryName()', 'notSearchable': true, visible: false, 'notSearchable': true},
                        {'name': $translate.instant('ADDRESS.LINE_1'), 'field': '_embedded.sourceAddress.addressLine1', visible: false, 'notSearchable': true},
                        {'name': $translate.instant('ADDRESS.HOUSE_NUMBER'), 'field': '_embedded.sourceAddress.', visible: false, 'notSearchable': true},
                        {'name': $translate.instant('ADDRESS.CITY'), 'field': '_embedded.sourceAddress.city', visible: false, 'notSearchable': true},
                        {'name': $translate.instant('ADDRESS.STATE'), 'field': '_embedded.sourceAddress.state', visible: false, 'notSearchable': true},
                        ...
                        {'name': $translate.instant('ADDRESS.COUNTRY'), 'field': '_embedded.sourceAddress.country', visible: false, 'notSearchable': true},
                        {'name': $translate.instant('ADDRESS.ZIP_POSTAL'), 'field': '_embedded.sourceAddress.postalCode', visible: false, 'notSearchable': true}
                    ],
                    hardwareSet: [
